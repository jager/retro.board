...
export class UserManagementService {
  ...
  findAll():ScrumMaster[] {
    let boards = [
      ...
      new Board(3,"Sprint: PLS-12 05.10-19.10", "19.10.2021 13:00", "19.10.2021 13:15", "HUBhhasouh((^234hff7jah72", false)
    ];
    return [
